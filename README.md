...
- **Full Vault Mode** - Send entire vault for comprehensive cross-referencing
- **Save as TODO** - Export AI responses as markdown checklists
...
- Model selector (GPT-5.x family)
- Full Vault mode for comprehensive reviews
- Save responses as TODO lists
...
Enable "Full vault" checkbox to send your entire vault as context instead of RAG search results. Ideal for:
- Cross-reference consistency checks
- Finding contradictions across notes
- Comprehensive reviews that need full context

**Smart Context Selection:** If your vault exceeds the model's context window, the AI automatically selects the most relevant sources for your query.

**Save as TODO:** After any AI response, click "Save as TODO" to export the response as a markdown checklist:

```markdown
# Vault Review

> Generated by Scribe AI on 2026-04-17 14:30
> Query: Check for inconsistencies across all character backstories

---

- [ ] Fix conflicting birth dates for Captain Aldric
- [ ] Resolve timeline issue with the Stormborn founding
- [ ] Add missing relationship between Tavern and Harbor
```

- Bullet points and numbered lists automatically convert to checkboxes
- Saves to `TODOs/` folder (if exists) or vault root
- Opens in Obsidian after saving
